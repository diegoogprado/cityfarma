      ...
      <div className="w-full max-w-4xl">
        <div className="bg-card rounded-2xl shadow-soft overflow-hidden">
          ...
          <div className="relative h-48 md:h-64 lg:h-72 overflow-hidden">
            <img 
              src={cityBanner} 
              alt="Loja física da Cityfarma Oswaldo Cruz, com produtos de higiene, beleza e cuidados pessoais" 
          ...
          <div className="p-6 md:p-8 lg:p-12 text-center">
            ...
            <div className="flex justify-center mb-6">
              <img 
                src={cityFarmaLogo} 
              alt="Logotipo Cityfarma Oswaldo Cruz" 
            ...
            <section className="mb-8 space-y-4">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
                Fale com nossa equipe pelo WhatsApp para tirar dúvidas e solicitar itens de perfumaria, dermocosméticos e produtos de cuidados pessoais.
              </p>
            </section>
